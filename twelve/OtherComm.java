...
public class OtherComm {
    ...
    void reportAmplifier() throws GameActionException {
        ...
        rc.writeSharedArray(AMP_SYM_CHANNEL, ((x+1) << 3) | code);
    }
        ...
        for (int i = 0; i < Robot.hComm.numBases; ++i){
            ...
            if (r != trueR && r1 != trueR){
                if (rc.canWriteSharedArray(ENEMY_CHANNEL + i, 0)){
                    rc.writeSharedArray(ENEMY_CHANNEL+i, 0);
                    continue;
                }
            }
    ...
    void reportClosestEnemyLauncher() throws GameActionException {
        ...
        if (rc.canWriteSharedArray(ENEMY_CHANNEL + Robot.hComm.hqIndex - 1, code)) rc.writeSharedArray(ENEMY_CHANNEL + Robot.hComm.hqIndex - 1, code);
    }
    ...
    void updateSymmetry() throws GameActionException {
        ...
        code |= (symCode & 0xFFF8);
        if (rc.canWriteSharedArray(AMP_SYM_CHANNEL, code)) rc.writeSharedArray(AMP_SYM_CHANNEL, code);
    }
