...
public class MicroAttacker {
    ...
    static int myDMG = RobotType.LAUNCHER.damage;
        ...
        try {
            ...
            for (RobotInfo unit : units) {
                ...
                switch(unit.getType()){
                    case LAUNCHER:
                        currentDMG = RobotType.LAUNCHER.damage;
                        currentActionRadius = RobotType.LAUNCHER.actionRadiusSquared;
                        break;
                    default:
                        currentDMG = 0;
                        break;
    ...
    class MicroInfo{
        ...
        public MicroInfo(Direction dir){
            ...
            if (dir != Direction.CENTER && !rc.canMove(dir)) canMove = false;
                ...
                try{
                    this.DMGreceived -= myDMG;
                    this.alliesTargeting += myDMG;
                } catch (Exception e){
                    e.printStackTrace();
                }
                minDistanceToEnemy = RANGE_EXTENDED_LAUNCHER;
            }
        }
