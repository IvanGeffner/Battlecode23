...
public class Carrier extends Robot {
    ...
    static int endExplore = 20;

    static int MAX_END_EXPLORE = 40;
    ...
    Carrier(RobotController rc) throws GameActionException {
        ...
        if (endExplore >= rc.getRoundNum() + MAX_END_EXPLORE) endExplore = rc.getRoundNum() + MAX_END_EXPLORE;
        im = new IslandManager();
        setMine(hComm.targetOnSpawn);
    }
    ...
    void updateMiningStatus() throws GameActionException{
        ...
        if (myMine == null && explore.mapdata.carrierTarget != null && rc.getRoundNum() > endExplore){
            setMine(explore.mapdata.carrierTarget);
        }
    ...
    MapLocation getTarget() throws GameActionException {
        ...
        if (rc.getRoundNum() - enemyDetectedRound <= CHICKEN_ROUNDS) return myBase;
        //anchor stuff
        ...
        //non-anchor stuff
        MapLocation target = mining ? myMine : myBase;
