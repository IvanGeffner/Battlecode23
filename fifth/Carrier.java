...
public class Carrier extends Robot {
    ...
    Carrier(RobotController rc) throws GameActionException {
        ...
        //endExplore = rc.getRoundNum() < 50 ? rc.getRoundNum() : rc.getRoundNum()+15;
        endExplore = rc.getRoundNum();
    ...
    MapLocation getTarget() throws GameActionException {
        ...
        if (target == null){
            ...
            if (target == null && baseIndex >= 0) target = bfsManager.bfsList[baseIndex].getFront();
        }
        return target;
    }
