...
public class MicroAttacker {
    ...
    int getDMGCarrier(RobotInfo unit){
        int resourceSum = unit.getResourceAmount(ResourceType.ADAMANTIUM)
                + unit.getResourceAmount(ResourceType.MANA)
                + unit.getResourceAmount(ResourceType.ELIXIR);
    ...
    boolean doMicro(){
        try {
            ...
            for (RobotInfo unit : units) {
                ...
                if (unit.getType() == RobotType.HEADQUARTERS) continue; //TODO: maybe add carriers
                ...
                switch(unit.getType()){
                    case LAUNCHER:
                        ...
                        break;
                    case CARRIER:
                        currentDMG = getDMGCarrier(unit);
                        if (currentDMG > myDMG) currentDMG = myDMG;
                        break;
                    default:
                        currentDMG = 0;
                        break;
            ...
            /*if (bestMicro != null){
                Constants.indicatorString += "Best Micro " + bestMicro.dir.name();
            }*/
